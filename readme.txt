...
http://localhost:8080/create?name=<user's name>&email=<user's e-mail address>
    to create a new user
    e.g. http://localhost:8080/create?name=Andrew&email=something

http://localhost:8080/update?id=<user id>&name=<new name>&email=<new e-mail address>
    to update an existing user
    e.g. http://localhost:8080/update?id=1&name=Dmitry&email=changed
